...
save_labelled_stream(stream_1, 'log/synthetic/sin_function/gradual_correlation_drift/stream_1.csv')
...
save_labelled_stream(stream_2, 'log/synthetic/sin_function/gradual_correlation_drift/stream_2.csv')
...
save_labelled_stream(stream_3, 'log/synthetic/sin_function/gradual_correlation_drift/stream_3.csv')
...
save_labelled_stream(stream_all,'log/synthetic/sin_function/gradual_correlation_drift/stream_all.csv')